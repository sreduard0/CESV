            ...
            <div class="card-header">
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="d-flex justify-content-sm-end">
                        <div class="col">
                            <button class="btn btn-primary" data-toggle="modal" data-target="#edit-drive">Cadastrar</button>
                        </div>
                    </div>
                </div>
                    ...
                    <form id="form-edit-drive">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col">
                                ...
                                <input minlength="2" maxlength="200" id="e_nameMot" name="e_nameMot" type="text"
                                    class="form-control" placeholder="Nome de guerra">
                            </div>
                            <div class="form-group col-md-2">
