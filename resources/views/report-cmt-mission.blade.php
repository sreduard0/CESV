                                        ...
                                        @foreach ($mission->vtrinfo as $vtr)
                                            ...
                                            <tr class="expandable-body">
                                                <td>
                                                    ...
                                                    <p class="m-l-30 text-muted">Km(s) rodados: {{ $vtr->od_total }}
                                                    </p>
                                                </td>
                                            </tr>
                                        @endforeach
                            ...
                            <form id="form-report">
                                ...
                                <div class="row">
                                    <div class="float-l col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group datet" id="dateFinishTarget"
                                                ...
                                                <input type="text" class="form-control datetimepicker-input"
                                                    data-target="#dateFinishTarget" id="dateFinish" name="dateFinish"
                                                    value="">
                                        ...
                                        <hr>
                                        <div class="form-group">
                                            <label for="ton">Peso em KG<span style="color:red">*</span></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="consDiesel"
                                                    ...
                                                    data-mask="" inputmode="text" placeholder="Consumo de diesel">
                                ...
                                <div class="row">
                                    <div class="form-group col">
                                        <label for="obsMission">Observações de conclusão </label> (Exemplo: alterações
                                        ou
                                        melhorias)
